...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "easy-meat-chicken-8r7j8.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "ce4794b2e63d1fb8e3d2d512ce7ce2c6";
...
export async function getProductByHandle(handle: string) {
  ...
  return data?.data?.product as ShopifyProduct["node"] | undefined;
}
